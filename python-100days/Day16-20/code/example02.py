...
def main():
    ...
    items2 = [random.randint(1, 100000) for _ in range(100000)]
    # print(bubble_sort(items2))  # 冒泡排序 超过60s，no result
    # print(select_sort(items2))   # 简单选择排序  超过60s，no result
    # print(merge_sort(items2))  # 归并排序 1.215s
    print(quick_sort(items2))  # 快速排序 0.46---0.5s
    items2 = [
